...
module.exports = class HomeyMCPApp extends Homey.App {
  ...
  async onInit() {
    try {
      ...
      this.toolRegistry.registerMeta(new SearchToolsTool(this.homey, this.toolRegistry, this.flowManager));
      this.toolRegistry.registerMeta(new UseToolTool(this.homey, this.toolRegistry, this.flowManager));
